...
The classic problem with which the essential ideas of dynamic programming can be introduced is the optimal route problem (shortest route considering distances,or cheapest route considering costs) [@Bertsekas2005;@brandimarte2013numerical]. A simple version of this problem is shown schematically in @fig-brandimarte_net. By exhaustion, we deploy the cost of path in @tbl-brandimarte_paths.

# Another grid-world exmple

::: {#exm-four-times-four-grid-world}
	The non-terminal states are $\mathcal{S} = \{1, 2, \dots, 14\}$. There are four
...
agent o↵ the grid in fact leave the state unchanged. Thus, for instance,
